...
cvdrisk_c_list_long <- tbls_pct_summary(
  .variable = c, .agerange_var = agerangecvd, .agerange_u_r_var = agerangecvd)
...
cvdrisk_d_list_long <- tbls_pct_summary(
  .variable = d, .cln2 = highrisk, .cln2_val = 1, 
