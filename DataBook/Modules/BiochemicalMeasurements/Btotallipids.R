...
btotallipids_b8_list_long <- tbls_mn_summary(.variable = b8)
...
btotallipids_b8mg_list_long <- tbls_mn_summary(.variable = b8mg)
...
btotallipids_e_list_long <- tbls_pct_summary(.variable = e)
...
btotallipids_f_list_long <- tbls_pct_summary(.variable = f)
...
btotallipids_c_list_long <- tbls_pct_summary(.variable = c)
...
# NOTE: PRODUCES SLIGHTLY DIFFERENT NUMBERS
btotallipids_d_list_long <- tbls_pct_summary(.variable = d)
