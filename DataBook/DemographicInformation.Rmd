...
# men, women, both sexes
cethnic_c_m_w_b <- join_m_w_b(cethnic_c, 0, cethnic_c_col_names)
```
```{r, eval=.GlobalEnv$.u_r_reg==TRUE}
# urban, rural
cethnic_c_u_r <- join_u_r(cethnic_c, 0, cethnic_c_col_names)
```

<br>

```{r}
cethnic_c_m_w_b$m %>% final_m_w_b_tbl(1, "Men", "Ethnic group of respondents", 8)
```

<br>

```{r}
cethnic_c_m_w_b$w %>% final_m_w_b_tbl(1, "Women", "Ethnic group of respondents", 8)
```

<br>

```{r}
cethnic_c_m_w_b$b %>% final_m_w_b_tbl(1, "Both sexes", "Ethnic group of respondents", 8)
```
...
rbind(cethnic_c_u_r$m_u, cethnic_c_u_r$m_r) %>% 
  final_u_r_tbl(1, "Men", "Ethnic group of respondents by type of settlement", 8)
```
...
rbind(cethnic_c_u_r$w_u, cethnic_c_u_r$w_r) %>% 
  final_u_r_tbl(1, "Women", "Ethnic group of respondents by type of settlement", 8)
```
...
rbind(cethnic_c_u_r$b_u, cethnic_c_u_r$b_r) %>% 
  final_u_r_tbl(1, "Both sexes", "Ethnic group of respondents by type of settlement", 8)
```
...
cethnic_c$b_reg %>% apply_hux(.col_names = cethnic_c_reg_col_names) %>% 
  final_m_w_b_tbl(1, "Both sexes", "Ethnic group of respondents by region", 8) 
```
