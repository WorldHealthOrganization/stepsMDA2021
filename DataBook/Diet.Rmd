...
# fs::dir_ls(diet_data_dir)

# only R files
r_files <- fs::dir_ls(diet_data_dir, regexp = "\\.R$") 
r_files

# read in just each R file, because in MDA not scripts are used
source(r_files[1]) # DX1
source(r_files[4]) # Ddays
source(r_files[13]) # Dservings
source(r_files[6]) # Dfiveormore
